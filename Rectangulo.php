...
<header>
    ...
    <form name="formularioDatos" method="post" action="arer.php">

<br/>

Introduzca la base: <input type="text" name="diam" value="">

<br/> <br/>

Introduzca la altura: <input type="text" name="altu" value="">
